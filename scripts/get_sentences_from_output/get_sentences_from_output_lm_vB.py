""" get_sentences_from_output_lm_vB.py

    It allows to process sentences with vB of prompts

    python get_sentences_from_output_lm_vB.py -j ./get_sentences_from_output_lm_vB/get_sentences_from_output_lm_gpt-j-6B.json
"""
